...
export const PAYMENT_METHOD_TAGS: TagRecord<PaymentMethod> = {
	TRANSFER: { id: 'TRANSFER', name: 'Przelew', color: 'blue' },
	CASH: { id: 'CASH', name: 'Gotówka', color: 'emerald' },
	BLIK: { id: 'BLIK', name: 'BLIK', color: 'violet' },
};

export const PAYMENT_METHOD_OPTIONS: TagOption[] = tagOptions(PAYMENT_METHOD_TAGS);
