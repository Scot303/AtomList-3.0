...
public enum Role {
	...
	EMPLOYEE(combine(RECEPTIONIST, EnumSet.of(READ_PAYMENTS, READ_LISTS, READ_INCOME_TRANSACTIONS, READ_EXPENSE_TRANSACTIONS, READ_INSTRUCTORS, READ_DISCOUNTS, READ_SMS, GENERATE_LIST_REPORT))),
