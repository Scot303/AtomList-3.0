...
public enum Role {
	...
	MANAGER(combine(EMPLOYEE, EnumSet.of(MODIFY_DISCOUNTS, MODIFY_LISTS, CLOSE_LISTS, MODIFY_PAYMENTS, MODIFY_INCOME_TRANSACTIONS, MODIFY_EXPENSE_TRANSACTIONS, MODIFY_INSTRUCTORS, SEND_SMS, VIEW_STATS, GENERATE_LIST_REPORT))),
