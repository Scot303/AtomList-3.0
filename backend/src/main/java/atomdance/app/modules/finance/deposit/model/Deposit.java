...
@Table(name = "deposits",
		uniqueConstraints = @UniqueConstraint(name = "uk_deposits_code_year_number", columnNames = {"code_year", "number"}),
...
public class Deposit {
	...
	/**
	 * A short handle a manager can quote off a receipt, shown as "W-1234/26" - see {@link #getCode()}.
	 * <p>
	 * Counts from 1 again in every {@link #codeYear}, so it only names a deposit alongside that year.
	 */
	...
	public String getCode() {
		return DepositCode.format(number, codeYear);
	}
