...
public record ListReportView(
	...
	public record Totals(
			long rowCount,
			long settledCount,
			long depositsReceivedTotalCount,
			long depositsReceivedTransferCount,
			long depositsReceivedCashCount,
			long depositsReceivedBlikCount,
			...
			BigDecimal depositsReceivedTransfer,
			BigDecimal depositsReceivedCash,
			BigDecimal depositsReceivedBlik,
