 ...
 * <p>
 * Several of these against one payment are how a split payment is recorded - 200 in cash today, 200 by
 * transfer next week, each with its own amount and date. Several against one deposit are how one handover
 * settles a whole family's groups.
 */
@Entity
@Getter @Setter @NoArgsConstructor @AllArgsConstructor @Builder
@Table(name = "payment_settlements",
		uniqueConstraints = @UniqueConstraint(name = "uk_payment_settlements_number", columnNames = "number"),
		indexes = {
				@Index(name = "idx_payment_settlements_payment_id", columnList = "payment_id"),
...
public class PaymentSettlement {
	...
	/**
	 * The settlement's half of "P-1234/5678" - see {@link #getCode()}.
	 */
