...
@Table(name = "payments",
		uniqueConstraints = @UniqueConstraint(name = "uk_payments_list_number", columnNames = {"list_id", "number"}),
		indexes = {
...
public class Payment {
	...
	/**
	 * A short handle a person can say out loud, shown as "P-12" - see {@link #getCode()}.
	 */
	...
	/**
	 * How {@link #number} is written and spoken: "P-12". Names a charge only alongside its {@link #list}.
	 */
